...
/***/ function(module, exports, __webpack_require__) {
	...
	MFL.prototype.request = function(requesttype, options, callback) {
	    ...
	    $.ajax({
	        url:'http://' + settings.host + settings.year + '/export?TYPE=' + requesttype + params + '&JSON=1',
	        beforeSend: function(){
	            console.log('http://' + settings.host + settings.year + '/export?TYPE=' + requesttype + params + '&JSON=1');
	        }
	    }).done(
	        function(response) {
